...
private ProgressDialog mDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        API_KEY=preferences.getString("apiKey",null);
        SESSION_ID=preferences.getString("sessionId",null);
        TOKEN=preferences.getString("tokenId",null);
                ...
                for(DocumentChange change:chang)
                {
                    switch (change.getType())
                    {
                        ...
                        //  params.height=  params.width=ViewGroup.LayoutParams.WRAP_CONTENT;
                           questions= change.getDocument().toObject(Questions.class);
                        ...
                        case REMOVED:
try{
    framgentQuestion.withdraw(Integer.parseInt(""+questions.getNo()));
manager.beginTransaction().remove(framgentQuestion).commit();
...
//    }
    ...
    public void onStreamReceived(Session session, Stream stream) {
       ...
       // Toast.makeText(getBaseContext(),"Stream recieved",Toast.LENGTH_LONG).show();
    }
    ...
    public void onError(Session session, OpentokError opentokError) {
        Toast.makeText(getBaseContext(),"Error: "+opentokError.getMessage(),Toast.LENGTH_LONG).show();
Log.d("logerror",""+opentokError.getMessage());
        Log.d("logerror",""+opentokError.getException());
        Log.d("logerror",""+opentokError.getErrorCode());
    }
